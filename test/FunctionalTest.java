...
public class FunctionalTest {
    ...
    public void redirectHomePage() {
        Result result = Helpers.route(application, HomeController.index());
    ...
    public void listComputersOnTheFirstPage() {
        Result result =  Helpers.route(application, HomeController.list(0, "name", "asc", ""));
    ...
    public void filterComputerByName() {
        Result result = Helpers.route(application, HomeController.list(0, "name", "asc", "Apple"));
    ...
    public void createANewComputer() {
        Result result = Helpers.route(application, HomeController.save());
        ...
        String saveUrl = HomeController.save().url();
        ...
        result = Helpers.route(application, HomeController.list(0, "name", "asc", "FooBar"));
        assertThat(result.status(), equalTo(Helpers.OK));
